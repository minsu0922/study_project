...
public class ClaudeProblemGenerator implements ProblemGenerator {
    ...
    static final String SYSTEM_PROMPT = """
            ...
            - 중급은 <원리를 처음 보는 상황에 적용>하게 한다. 지문에 상황이 한 문단 있다.
              오답은 원리를 잘못 적용한 판단이다 — 원리를 이해했다면 틀렸음을 안다.
            - 고급은 <여러 대응 중 무엇을 고를지>를 묻는다. 지문에 상황과 이미 시도한 것이 있다.
              오답은 조건이 달랐다면 옳았을 대응이다 — 넷 다 그럴듯하고, 이 상황이라서 갈린다.
            ...
            - 초급인데 두 개념을 나란히 놓고 "각각 어떻게 되는가"를 물었다면 중급이다. 하나만 물어라.
