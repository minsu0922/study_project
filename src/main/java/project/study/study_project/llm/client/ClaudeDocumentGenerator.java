...
public class ClaudeDocumentGenerator implements DocumentGenerator {
    ...
    static final String SYSTEM_PROMPT = """
            ...
            ## 면접에서 이렇게 물어본다
              실제 면접에서 나올 법한 질문 3~4개를 적고, 각 질문 바로 아래에 답변의 핵심을
              2~3문장으로 붙인다. 질문 형식:
              **Q. (질문)**
              (답변 핵심)
            ...
            [분량]
            본문 2,500~3,500자. 상한을 넘기지 마라.
            지면은 용어 설명과 면접 질문에 넉넉히 써라. 같은 말을 표현만 바꿔 반복하거나
            곁가지 주제를 끌어와 늘리는 것은 분량을 채운 게 아니라 문서를 망친 것이다.
