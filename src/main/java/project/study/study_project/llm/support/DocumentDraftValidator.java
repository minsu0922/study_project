...
public final class DocumentDraftValidator {
    ...
    /**
     * 권장 분량 상한(경고). 프롬프트가 요구하는 "4,000~5,500자"의 위쪽 끝.
     ...
     * 지시를 3,500자에서 5,500자로 올리면서 여기도 함께 올렸다. 한쪽만 고치면 <b>지시대로 쓴
     * 문서가 전부 경고를 달고 나오고</b>, 경고가 매번 뜨면 사람이 경고 자체를 안 보게 된다.
     *
     ...
     * 공개한 것과 같은 이유다.
     */
    public static final int WARN_LENGTH = 5_500;
